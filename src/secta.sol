...
contract SectToken is ERC20('Secta Finance Governance Token', 'SECTA') {
    ...
    /**
     * @notice Approves tokens of signatory to `spender`
     * @param owner The address to approve
     * @param spender The address to get approval
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying SECTs (not scaled);
